...
contract DeployAccessControllerUpgradeable is Script {
    function run() external {
        ...
        console.log("AccessControllerUpgradeable Implementation deployed:", address(implementation));
        ...
        console.log("========================================");
        console.log("AccessControllerUpgradeable Implementation:", address(implementation));
        console.log("ProxyAdmin:", address(proxyAdmin));
        console.log("AccessControllerUpgradeable Proxy:", address(proxy));
